...
public class PostRequestWithHeader {
    ...
    public PostRequestWithHeader(Context context, String token, JSONObject postData, String requestUrl, ProgressBar pb, boolean isLoaderRequired,
    ...
    private void init() {
        ...
        //mApiService = RetrofitClient.getClient(context.getString(R.string.base_url)).create(APIService.class);
    ...
    public void execute() {
        ...
        if (mApiService != null) {
            ...
            Call<ResponseBody> bodyCall = mApiService.RequestWithHeader(token, requestUrl, requestBody);
